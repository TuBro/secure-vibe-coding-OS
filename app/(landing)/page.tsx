      ...
      <section className="bg-muted/50 py-12 md:py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-8 mx-auto max-w-2xl space-y-4 text-center">
              ...
              <p>Choose the plan that fits your security monitoring needs. From startups to enterprise applications. THIS IS JUST AN EXAMPLE PRICING SECTION... the Vaka Tu80 Core OS is free...</p>
          </div>
          <CustomClerkPricing />
        </div>
      </section>
